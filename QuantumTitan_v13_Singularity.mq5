//+------------------------------------------------------------------+
//|                                 QuantumTitan_v13_Singularity.mq5 |
//|          v13.00 Singularity Institutional Quant Framework        |
...
//+------------------------------------------------------------------+
#property copyright "QuantumTitan Institutional Quant Framework v13.00"
#property link      "https://github.com/jadjadjade002/trader-bot"
#property version   "13.00"
#property description "v13.00 Singularity: Auto-Adaptive Multi-Timeframe Matrix (M1 Scalp, M5 Intraday, M15 Swing, H1 Macro)"
...
input ulong    InpMagicNumber          = 991300;     // Base Magic Number (v13 Singularity ID)
...
{
   Print("══════════════════════════════════════════════════════════════");
   Print("🚀 INITIALIZING QUANTUMTITAN v13.00 SINGULARITY...");
   Print("══════════════════════════════════════════════════════════════");
   ...
   g_hud.DispatchAlert("SYSTEM BOOT", StringFormat("QuantumTitan v13.00 Singularity activated on %s (%s - %s, Magic: %I64u)",
      _Symbol, EnumToString(_Period), g_profile.profileName, g_actualMagic), true);

   PrintFormat("✅ QUANTUMTITAN v13.00 SINGULARITY INITIALIZED WITH 0 ERRORS.");
...
{
   Print("🛑 Deinitializing QuantumTitan v13.00 Singularity... Reason: ", reason);
