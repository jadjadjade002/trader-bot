...
//|          v16.00 Apex Singularity Institutional Quant Framework   |
...
//+------------------------------------------------------------------+
#property copyright "QuantumTitan Institutional Quant Framework v16.00 Apex"
#property link      "https://github.com/jadjadjade002/trader-bot"
#property version   "15.00"
#property description "v16.00 Apex Singularity: Institutional Multi-Timeframe Matrix (M1 Scalp, M5 Intraday, M15 Swing, H1 Macro) with 11 SMC & PA Modules"
...
{
   Print("══════════════════════════════════════════════════════════════");
   Print("🚀 INITIALIZING QUANTUMTITAN v16.00 APEX...");
   Print("══════════════════════════════════════════════════════════════");
   ...
   g_hud.DispatchAlert("SYSTEM BOOT", StringFormat("QuantumTitan v16.00 Apex activated on %s (%s - %s, Magic: %I64u)",
      _Symbol, EnumToString(_Period), g_profile.profileName, g_actualMagic), true);

   PrintFormat("✅ QUANTUMTITAN v16.00 APEX SINGULARITY INITIALIZED WITH 0 ERRORS.");
...
{
   Print("🛑 Deinitializing QuantumTitan v16.00 Apex... Reason: ", reason);
...
void OnTick()
{
   ...
   string avgPriceObj = "QT16_BASKET_AVG";
