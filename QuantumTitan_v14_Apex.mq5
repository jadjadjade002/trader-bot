//+------------------------------------------------------------------+
//|                                     QuantumTitan_v14_Apex.mq5    |
//|          v14.00 Apex Singularity Institutional Quant Framework   |
...
//+------------------------------------------------------------------+
#property copyright "QuantumTitan Institutional Quant Framework v14.00 Apex"
#property link      "https://github.com/jadjadjade002/trader-bot"
#property version   "14.00"
#property description "v14.00 Apex Singularity: Institutional Multi-Timeframe Matrix (M1 Scalp, M5 Intraday, M15 Swing, H1 Macro) with 11 SMC & PA Modules"
...
{
   Print("══════════════════════════════════════════════════════════════");
   Print("🚀 INITIALIZING QUANTUMTITAN v14.00 APEX...");
   Print("══════════════════════════════════════════════════════════════");
   ...
   g_hud.DispatchAlert("SYSTEM BOOT", StringFormat("QuantumTitan v14.00 Apex activated on %s (%s - %s, Magic: %I64u)",
      _Symbol, EnumToString(_Period), g_profile.profileName, g_actualMagic), true);

   PrintFormat("✅ QUANTUMTITAN v14.00 APEX SINGULARITY INITIALIZED WITH 0 ERRORS.");
...
{
   Print("🛑 Deinitializing QuantumTitan v14.00 Apex... Reason: ", reason);
